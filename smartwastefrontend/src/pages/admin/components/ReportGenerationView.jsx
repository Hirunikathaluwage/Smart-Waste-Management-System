...
import { BarChart3, TrendingUp, Recycle, MapPin, AlertCircle } from 'lucide-react';
...
const ReportGenerationView = () => {
  ...
  const statistics = [
    { id: 'total-waste', label: 'Total Waste', value: '2,847 kg', change: '+12% from last month', icon: TrendingUp, iconColor: '#4CBB17' },
    { id: 'recycling-rate', label: 'Recycling Rate', value: '68%', change: '+6% improvement', icon: Recycle, iconColor: '#3b82f6' },
    { id: 'routes-active', label: 'Routes Active', value: '24', change: '2 optimized', icon: MapPin, iconColor: '#f59e0b' },
    { id: 'waste-zones', label: 'High Waste Zones', value: '7', change: 'Requires attention', icon: AlertCircle, iconColor: '#ef4444' }
  ];
  ...
  const handleGenerateReport = () =>
    console.log({ reportType, area, dateRange, selectedWasteTypes });
