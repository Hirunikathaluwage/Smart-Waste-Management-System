...
import { Menu, X, Truck, Trash2, Package, Clock, CheckSquare, Bell, LogOut, MapPin } from 'lucide-react';

/**
 * Complete Dashboard Layout with Sidebar and Top Navigation - Worker Version
 */
const DashboardLayout = ({
  ...
  logo = 'App',
  logoIcon = null,
  user = { name: 'Worker User', avatar: null },
  onLogout = () => {},
  pageTitle = '',
  pageSubtitle = '',
  children
          ...
          <div className="px-8 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer">
                ...
                <span className="text-sm font-medium text-gray-700">{user?.name || 'Worker'}</span>
              </div>
...
const App = () => {
  ...
  return (
    <DashboardLayout
      ...
      pageTitle="My Routes"
      pageSubtitle="View your assigned routes and collection schedule for today"
    >
      {/* Your dashboard content goes here */}
      <div className="text-center text-gray-400 py-20">
        <p className="text-lg">Worker Dashboard Content</p>
      </div>
    </DashboardLayout>
  );
};
